<x-app-layout>
    ...
    <div class="py-6">
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            {{-- Welcome Card --}}
            <div
                class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl shadow-sm p-6 mb-6 text-white">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div
                            class="w-11 h-11 rounded-lg bg-blue-100 flex items-center justify-center">
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div
                            class="w-11 h-11 rounded-lg bg-green-100 flex items-center justify-center">
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div
                            class="w-11 h-11 rounded-lg bg-yellow-100 flex items-center justify-center">
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div
                            class="w-11 h-11 rounded-lg bg-red-100 flex items-center justify-center">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="space-y-5 max-h-[320px] overflow-y-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-5 mb-6">
                ...
                <a href="{{ route('warga.index') }}"
                    class="bg-white rounded-xl shadow-sm hover:shadow-md transition p-5 flex flex-col items-center">
